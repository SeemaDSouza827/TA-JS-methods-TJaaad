...
if( fruits.at(0) == "Dragon Fruit" && fruits.at(1) == "Guava"){
    console.log(true);
}
...
numbersTwo.forEach((num)=>console.log(num));
...
function tripel(numbersThree){
    return numbersThree * 3 ;
}

// let tripleNumbers = numbersThree.map(tripel);
tripleNumbers = numbersThree.map( (num) => num *3 );
console.log(tripleNumbers);
