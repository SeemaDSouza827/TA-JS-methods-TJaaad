...
*/
for(let i=0;i<indexOfIs.length; i++){
  console.log(`${indexOfIs.charAt(i)}`);
}
console.log(indexOfIs);
/*
3. Log the message saying `The index of first is in quote is 7`
*/
console.log(`The index of the first "is" in Quote is ${quote.indexOf('is')} `);
...
*/
console.log(quote.lastIndexOf("a",quote.length - 1));
/*
...
*/
quote.slice();
/* does quote, from, to starts with "A"
*/
