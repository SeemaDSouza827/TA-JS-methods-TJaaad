...
*/
let numbers=[4,6,33,8,9,57,2,43,76,98,100];
function addTwoToArray(numbers,cb){
    let finalArray =[];
  for(let i=0; i<numbers.length; i++){    
   finalArray.push(cb(numbers[i]));
 }
 return finalArray;
}
